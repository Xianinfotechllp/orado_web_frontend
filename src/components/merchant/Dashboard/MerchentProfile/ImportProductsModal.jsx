        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-semibold mb-1">Follow these steps to import products:</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-semibold text-gray-800">Fill in your product data</h4>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                ...
                <li>• <strong>Category ID</strong> – MongoDB category reference</li>
                <li>• <strong>Food Type</strong> – veg / non-veg</li>
                <li>• <strong>Status</strong> – Active / Inactive</li>
                <li>• <strong>Availability</strong> – always / time-based / out-of-stock</li>
              </ul>
            </div>
          </div>
