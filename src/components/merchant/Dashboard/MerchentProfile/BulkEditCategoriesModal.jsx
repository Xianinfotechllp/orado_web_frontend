        ...
        <div className="bg-gradient-to-r from-purple-500 to-blue-600 text-white p-6 rounded-t-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Upload size={24} />
              <h3 className="text-xl font-bold">Bulk Edit Categories</h3>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-semibold mb-1">You can bulk edit by exporting current categories, editing in Excel, then re-uploading.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-semibold text-gray-800">Export current categories</h4>
            </div>
            <button
              onClick={handleExportCurrent}
              className="w-full flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 px-4 rounded-lg transition-colors"
            >
              <Download size={18} />
              Export Categories
            </button>
