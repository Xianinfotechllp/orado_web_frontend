...
import RestaurantChatList from './RestruantCustomerChatList';
import RestaurantChatWindow from './RestaurantChatWindow';

const RestaurantChatDashboard = () => {
