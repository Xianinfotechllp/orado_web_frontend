...
const NotificationsPage = () => {
  ...
  const notificationTypes = [
    { key: "all", label: "All", icon: Bell, count: notifications.length },
    {
      ...
      label: "Order Updates",
      icon: Package,
      count: notifications.filter((n) => n.type === "orderUpdates").length,
    },
    {
      key: "promotions",
      label: "Promotions",
    ...
    },
    {
      ...
      icon: Wallet,
      count: notifications.filter((n) => n.type === "walletCredits").length,
    },
    {
      key: "newFeatures",
      label: "New Features",
      icon: Sparkles,
      count: notifications.filter((n) => n.type === "newFeatures").length,
    },
    {
      key: "serviceAlerts",
      label: "Service Alerts",
      icon: AlertTriangle,
      count: notifications.filter((n) => n.type === "serviceAlerts").length,
    },
  ];
