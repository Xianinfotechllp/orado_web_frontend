  ...
  const handleSaveAllocationSettings = (settings) => {
    ...
    const requestBody = {
      ...
      fifoSettings: {
        ...
        startAllocationBeforeTaskTimeMin:
          settings.fifo?.startAllocationBeforeTaskTimeMin || 0,
        ...
        clubbingSettings: {
          deliveryDistanceKm:
            settings.fifo?.clubbingSettings?.deliveryDistanceKm || 5,
          orderThresholdTimeSec:
            settings.fifo?.clubbingSettings?.orderThresholdTimeSec || 120,
          additionalTasksToBeClubbed:
            settings.fifo?.clubbingSettings?.additionalTasksToBeClubbed || 2,
        },
      },
    };
