...
const DeliverySettings = () => {
  ...
  const templateOptions = [
    ...
    { value: 'Order Details', label: 'Order Details' }
  ];
    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        {[
          {
            title: "Free Delivery",
            description: "Enable this toggle to activate the option to waive off Delivery charges where delivery is by admin.",
                      ...
                      <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                          <p className="text-sm text-gray-700">
                            Showing <span className="font-medium">1</span> to <span className="font-medium">5</span> of <span className="font-medium">5</span> entries
                          </p>
                        </div>
                        <div>
