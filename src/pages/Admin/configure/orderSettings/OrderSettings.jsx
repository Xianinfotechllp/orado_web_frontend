  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <h3 className="text-lg font-medium text-gray-800 flex items-center gap-2">
              Accept/Reject Order
              <span className="text-gray-400 hover:text-gray-600 cursor-help" title="Control manual order acceptance">
              ...
              <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                <div className="space-y-3 text-sm text-gray-600 mb-4">
                  <p className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-100 text-blue-800 text-xs font-medium">1</span>
                    <span><span className="font-medium">On Demand Order:</span> If not accepted within X minutes of order time, it will be cancelled automatically.</span>
                  </p>
                  <p className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-100 text-blue-800 text-xs font-medium">2</span>
                    <span><span className="font-medium">Scheduled Order:</span> If not accepted within X minutes of scheduled time, it will be cancelled automatically.</span>
                  </p>
                </div>
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <h3 className="text-lg font-medium text-gray-800">Schedule Adjustment</h3>
            <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="md:w-2/3">
            <div className="bg-gray-50/50 p-4 rounded-lg">
              <div className="text-sm text-gray-600 mb-4 flex items-start gap-2">
                <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-100 text-blue-800 text-xs font-medium">i</span>
                <span><span className="font-medium">On Demand Order:</span> System will automatically adjust pickup and delivery time by the acceptance delay if order is not accepted within threshold.</span>
              </div>
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-2/3">
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
              <div className="text-sm text-gray-600">
                <p>Enable Admin to edit orders before acceptance by restaurants</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input 
                  type="checkbox" 
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <h3 className="text-lg font-medium text-gray-800 flex items-center gap-2">
              Auto Printing
              <span className="text-gray-400 hover:text-gray-600 cursor-help" title="Bluetooth printer settings">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
              </span>
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Task reflection delay
            </p>
          </div>
          <div className="md:w-2/3">
            <div className="bg-gray-50/50 p-4 rounded-lg">
              <p className="text-sm text-gray-600 mb-4">Scheduled tasks will reflect immediately on TOOKAN</p>
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <h3 className="text-lg font-medium text-gray-800">Status Control</h3>
            <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="md:w-2/3">
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
              <div className="text-sm text-gray-600">
                <p>Allow merchants to change order status to Completed/Cancelled</p>
                <p className="text-xs text-gray-500 mt-1">Dashboard only (not available in native apps)</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input 
                  type="checkbox" 
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <h3 className="text-lg font-medium text-gray-800 flex items-center gap-2">
              Tax Labels
              <span className="text-gray-400 hover:text-gray-600 cursor-help" title="Email invoice settings">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
              </span>
          ...
          <div className="md:w-2/3">
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
              <div className="text-sm text-gray-600">
                ...
                <p className="text-xs text-gray-500 mt-1">Remove unused tags from HTML before sending</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input 
                  type="checkbox" 
      ...
      <section className="py-6 border-b border-gray-200">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-2/3">
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
              <div className="text-sm text-gray-600">
                <p>Define tags to automatically assign agents with matching tags</p>
                <p className="text-xs text-gray-500 mt-1">Tags must match Tookan configuration</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input 
                  type="checkbox" 
