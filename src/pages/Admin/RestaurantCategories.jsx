...
import { ChevronRight, Star, Clock, Search, Plus, X, Edit2, Trash2 } from 'lucide-react';
...
const RestaurantCategories = () => {
    ...
    useEffect(() => {
        const fetchRestaurantAndCategories = async () => {
            try {
                setLoading(true);
                const restaurantRes = await axios.get(`http://localhost:5000/restaurants/${restaurantId}`);
        ...
        try {
            ...
            if (editingCategory) {
                ...
                const response = await axios.put(
                    `http://localhost:5000/restaurants/categories/${editingCategory}`,
                    formData,
                    {
                        headers: {
                ...
                const response = await axios.post(
                    `http://localhost:5000/restaurants/${restaurantId}/categories`,
                    formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data',
    ...
    const handleDeleteCategory = async (categoryId) => {
        ...
        try {
            await axios.delete(
                `http://localhost:5000/restaurants/categories/${categoryId}`,
                {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    },
    ...
    return (
        <div className="min-h-screen bg-[#f8f8f8]">
                    ...
                    {restaurant && (
                        <div className="flex items-center justify-between pb-2">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">{restaurant.cuisines?.join(', ') || 'Multi-cuisine'}</p>
                            </div>
            ...
            <main className="max-w-6xl mx-auto px-4 py-6">
                        ...
                        <form onSubmit={handleSubmitCategory}>
                            ...
                            <div className="flex items-center space-x-6 mb-4">
                                ...
                                <label className="inline-flex items-center">
                                    <input
                                        ...
                                        onChange={(e) => setCategoryForm({ ...categoryForm, autoOnOff: e.target.checked })}
                                        className="form-checkbox h-4 w-4 text-orange-500 rounded focus:ring-orange-500 border-gray-300"
                                    />
                                    <span className="ml-2 text-sm text-gray-700">Auto On/Off</span>
                                </label>
                            </div>
                            ...
                            <div className="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-white text-sm font-medium ${categoryForm.description.length < 100
                ...
                {filteredCategories.length === 0 && !showCreateForm && !editingCategory ? (
                    <div className="flex flex-col items-center justify-center py-16">
                        ...
                        <p className="text-gray-500 mb-6 text-sm">Get started by creating your first menu category</p>
                        <button
