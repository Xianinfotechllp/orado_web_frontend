...
const RestaurantList = () => {
  ...
  useEffect(() => {
    ...
    const fetchRestaurants = async () => {
      try {
        // In real app, this would be: const res = await axios.get('http://localhost:5000/restaurants/all-restaurants');
        setTimeout(() => {
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:flex items-center text-sm text-gray-600">
                ...
                <span className="text-gray-800 ml-1">Thodupuzha, Kerala</span>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredRestaurants.map((restaurant) => (
                <div key={restaurant._id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                  {/* Restaurant Image */}
