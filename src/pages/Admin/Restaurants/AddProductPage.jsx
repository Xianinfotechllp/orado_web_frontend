...
const AddProductPage = ({
  ...
  initialData = null, // Pass existing product data for edit mode
  ...
  const [formData, setFormData] = useState({
    ...
    foodType: "veg", // Add this with default value
  });
  ...
  useEffect(() => {
    if (isEditMode && initialData) {
      setFormData({
        ...initialData,
        // Convert availability object to form structure
        availability: initialData.availability?.type || "always",
        availableFromTime: initialData.availability?.time || "17:00",
        // Convert images if they're URLs to File objects (you'll need to handle this properly)
